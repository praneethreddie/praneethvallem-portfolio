...
export default function HeroSection() {
  ...
  return (
    <AnimatedSection
      id="home"
      className="w-full pt-8 sm:pt-32 pb-24 sm:pb-16 flex flex-col items-center min-h-[40vh] bg-gradient-to-b from-accent/5 via-transparent to-transparent relative"
    >
